...
[b][b][FFC0CB]youtube: WLF[/b]

[b][FFC0CB]subcribe: my_channel[00FFFF]
 
[b][b][FFA500]telegram: @Dyr Nur[/b]

[b][FFA500]telegram contact: @Dyr Nur[A52A2A]
 
Enjoy the bot my friend.......

[C][b][00FFFF] Created by KALAM 
...
async def MaiiiinE():
    Uid , Pw = '4278433152','D561AA680F665FB088D3FE428C2A261381F04C3BEB7CB8264CBD70DEB582E7D2'
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using DYR Bot!")
    sys.exit(0)
...
async def StarTinG():
    while True:
        try:
            ...
            print("👋 Thanks for using DYR Nur Bot!")
            break
